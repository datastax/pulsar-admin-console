<template>
    <div class="java-consumer">
        <h5>Simple Consumer</h5>
        <p>This sample creates a consumer on a topic, consumes a message, then closes the consumer.</p>
        ...
        <div class="va-row">
            ...
            <div class="flex md9">
                <div class="va-row">
                    <div class="flex md3">
                        ...
                        option-key="id"
                        name="cluster-select-java-consumer"
                    ...
                    <div class="flex md3">
                        ...
                        ref="nsSelect"
                        name="namespace-select-java-consumer"
                        :clearable="clearable"
                        />
                    </div>
            ...
            <div class="flex md3">
                <a href="https://github.com/kafkaesque-io/sample-java-consumer-gradle" style="float: right;" target="_blank" rel="noopener noreferrer">
        ...
        <div class="form-group with-icon-right">
            <pre v-highlightjs="simpleConsumer"><code class="java"></code></pre>
