<template>
    <div class="nodejs-consumer">
        <h5>Simple Consumer</h5>
        <p>This sample creates a consumer on a topic, waits for a message, acknowledges it in a loop.</p>
        ...
        <div class="va-row">
            ...
            <div class="flex md3">
                <a href="https://github.com/kafkaesque-io/sample-pulsar-node-client/blob/master/src/consumer.js" style="float: right;" target="_blank" rel="noopener noreferrer">
        ...
        <div class="form-group with-icon-right">
            <pre v-highlightjs="simpleConsumer"><code class="nodejs"></code></pre>
...
(async () => {
  ...
  const subscriptionName = '${this.currentSubscription}'
