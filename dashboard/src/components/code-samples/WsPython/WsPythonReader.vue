<template>
    <div class="ws-python-reader">
        <h5>Simple Reader</h5>
        <p>This sample creates a reader on a topic and reads the earliest or latest messages from the topic.</p>
        <div class="va-row">
            <div class="flex md12">
                <div class="va-row">
                    <div class="flex md3">
        ...
        <div class="form-group with-icon-right">
            <pre v-highlightjs="simpleReader"><code class="ws-python"></code></pre>
...
TOPIC = '${this.serviceUrl}/ws/v2/reader/persistent/${this.tenant}/${this.currentNamespace.id}/${this.currentTopic}?messageId=${this.currentPosition.id}'
