...
<template>
    <div class="python-consumer">
        ...
        <div class="form-group with-icon-right">
            <pre v-highlightjs="simpleConsumer"><code class="python"></code></pre>
...
consumer = client.subscribe('persistent://${this.tenant}/${this.currentNamespace.id}/${this.currentTopic}', '${this.currentSubscription}')
