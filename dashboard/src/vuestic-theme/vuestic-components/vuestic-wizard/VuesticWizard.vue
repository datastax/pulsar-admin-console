  ...
  >
    ...
    <div class="wizard-body">
      ...
      <div class="wizard-body-actions" v-if="!wizardCompleted">
        ...
        <div class="flex md12 wizard-cancel-div" >
          <div class="btn-container" v-if="cancelRoute">
            <button class="btn btn-micro btn-secondary"
...
export default {
  ...
  beforeDestroy () {
    this.$off('wizardLayoutChange', this.updateLayout)
  },
  methods: {
    updateLayout (layout) {
...
$wizard-indicator-vl-width: 15rem;
